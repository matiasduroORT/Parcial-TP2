...
app.use("/", salesRouter) // Manejar middlewares, nos permite conectar nuestro server
app.use("/", storeRouter) // Manejar middlewares, nos permite conectar nuestro server
